...
const stepExecutors = {
    ...
    "send_email": async (step, context) => {
        ...
        // Use result from previous step if relevant
        const lastResultText = context.lastResult?.message || context.lastResult?.data?.answer || "";
        const body = step.params?.body || `
            <h3>Action Report: ${step.label}</h3>
            <p>Execution Summary: ${lastResultText}</p>
